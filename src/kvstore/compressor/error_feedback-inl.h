...
struct MomentumErrorFeedbackKernel {
...
void MomentumErrorFeedbackKernalLaunch(mshadow::Stream<xpu>* s, const mxnet::TBlob& in,
                                       mxnet::TBlob& out, const float alpha) {
  mxnet::op::mxnet_op::Kernel<MomentumErrorFeedbackKernel, xpu>::Launch(
      s,
      in.Size(),          // array size
...
inline void MomentumErrorFeedbackImpl(mshadow::Stream<mshadow::cpu>* s, const mxnet::TBlob& in,
                                      mxnet::TBlob& out, const float alpha) {
  MomentumErrorFeedbackKernalLaunch(s, in, out, alpha);
}

#if MXNET_USE_CUDA
void MomentumErrorFeedbackImpl(mshadow::Stream<mshadow::gpu>* s, const mxnet::TBlob& in,
                               mxnet::TBlob& out, const float alpha);
